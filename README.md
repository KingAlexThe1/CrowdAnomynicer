...
Option 2:
Load existiung file to anomynice.
...
Option2: on the top left is a input field to paste the path to the video. right to the field is a play button to sart the video processing. if cligged the play button will disapear an a new label with " video processing" will aspear. if finsched the label disapears and the playbutton will apear again. the process can be sartet again.
